...
def emit_motor_tables(xdpi=75, exposure=0x2a00, travel=1310, chan_gain=1.0):
    ...
    # 2400 is on the same high-res tier as 1200 (0x60) - DERIVED, needs hardware
    # confirmation of carriage travel (no 2400 capture to validate byte-exact against).
...
def emit_scan_program(xdpi, ydpi, width, lines, mode, depth=8, ytop=0, matrix=None):
    """Parametric imaging program, verified byte-exact against a USB capture of
    a 75x75 flatbed scan over USB 2.0. Emits register writes directly. The

...
|--------|------|-----------|--------|---------|
| Canon CanoScan 8000F | Flatbed scanner (USB) | macOS/Linux (Python CLI + GUI) | 75/300/600 dpi verified; colour/gray/line-art, 8/16-bit; 150/1200 dpi WIP | [`scan8000f`](https://github.com/iappyx/ai-hardware-revival/tree/main/scanners/Canon/CanoScan%208000f) | 
